...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'Pureco Pure Vegetable Oil 1L',
                'barcode' => '6001099887711',
                'category_id' => $catOil->id,
                'unit' => 'bottle',
                'selling_price' => 42.00,
                'cost_price' => 34.00,
                'quantity' => 4, // Low stock on purpose for testing!
                'reorder_level' => 10,
            ],
        ];
        ...
        Customer::create([
            'tenant_id' => $tenant->id,
            'shop_id'   => $shop->id,
            'name'      => 'Kofi Kinaata (Wholesale Client)',
            'phone'     => '0240111222',
            'credit_limit' => 2000.00,
            'credit_balance' => 350.00, // Owes GH₵ 350
        ]);

        Customer::create([
            'tenant_id' => $tenant->id,
            'shop_id'   => $shop->id,
            'name'      => 'Auntie Mary (Neighbourhood Store)',
            'phone'     => '0277333444',
